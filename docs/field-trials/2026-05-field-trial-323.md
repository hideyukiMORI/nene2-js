# FT323: parseProblemDetails case 13
...
parseProblemDetails case 13 (`bulk_prob_parse_13`, fixture).

## What was exercised

`npm run test:ft-marathon` — category `problem-bulk`.

## DX Review

### Persona A — TypeScript app developer

Problem parsers **Risk:** low
