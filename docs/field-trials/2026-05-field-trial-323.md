# FT323: tags limit+offset combo 5
...
tags limit+offset combo 5. Handler `bulk_q_tags_combo_5` (fixture, category `query-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT323"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT323 | 1     | PASS (automated) |
...
- Scenario `bulk_q_tags_combo_5` completed under Vitest.
