# FT331: tags limit+offset combo 9
...
tags limit+offset combo 9. Handler `bulk_q_tags_combo_9` (fixture, category `query-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT331"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT331 | 1     | PASS (automated) |
...
- Scenario `bulk_q_tags_combo_9` completed under Vitest.
