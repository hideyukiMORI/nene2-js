# FT401: validation field index 16
...
validation field index 16. Handler `bulk_vdx_fields_16` (fixture, category `validation-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT401"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT401 | 1     | PASS (automated) |
...
- Scenario `bulk_vdx_fields_16` completed under Vitest.
