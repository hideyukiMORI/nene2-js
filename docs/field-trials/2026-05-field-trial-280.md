...
notes list limit=100. Handler `bulk_q_notes_limit_100` (fixture, category `query-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| ----------- | -------------------------------------------------------------------------------------- |
| Category    | `query-bulk`                                                                           |
| Handler     | `bulk_q_notes_limit_100`                                                               |
| Mode        | fixture                                                                                |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT280"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT280 | 1     | PASS (automated) |
...
- Scenario `bulk_q_notes_limit_100` completed under Vitest.
- Persona A path: Pagination limit encoding
...
### O1: 自動シナリオ `bulk_q_notes_limit_100`
