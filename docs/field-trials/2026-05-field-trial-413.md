# FT413: parseProblemDetails case 3
...
parseProblemDetails case 3. Handler `bulk_prob_parse_3` (fixture, category `problem-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT413"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT413 | 1     | PASS (automated) |
...
- Scenario `bulk_prob_parse_3` completed under Vitest.
