# FT214: [py_dev] client: notes_list_fixture
...
[py_dev] client: notes_list_fixture. Handler `onb_client_py_dev_notes_list_fixture` (fixture, category `docs-client-onboarding`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| Handler     | `onb_client_py_dev_notes_list_fixture`                                                 |
| Mode        | fixture                                                                                |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT214"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT214 | 1     | PASS (automated) |
...
- Scenario `onb_client_py_dev_notes_list_fixture` completed under Vitest.
...
### O1: 自動シナリオ `onb_client_py_dev_notes_list_fixture`
