# FT416: parseProblemDetails case 6
...
parseProblemDetails case 6. Handler `bulk_prob_parse_6` (fixture, category `problem-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT416"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT416 | 1     | PASS (automated) |
...
- Scenario `bulk_prob_parse_6` completed under Vitest.
