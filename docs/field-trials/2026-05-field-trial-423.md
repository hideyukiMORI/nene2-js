# FT423: parseProblemDetails case 13
...
parseProblemDetails case 13. Handler `bulk_prob_parse_13` (fixture, category `problem-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT423"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT423 | 1     | PASS (automated) |
...
- Scenario `bulk_prob_parse_13` completed under Vitest.
