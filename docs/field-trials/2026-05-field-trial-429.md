# FT429: parseProblemDetails case 19
...
parseProblemDetails case 19. Handler `bulk_prob_parse_19` (fixture, category `problem-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT429"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT429 | 1     | PASS (automated) |
...
- Scenario `bulk_prob_parse_19` completed under Vitest.
