# FT428: parseProblemDetails case 18
...
parseProblemDetails case 18. Handler `bulk_prob_parse_18` (fixture, category `problem-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT428"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT428 | 1     | PASS (automated) |
...
- Scenario `bulk_prob_parse_18` completed under Vitest.
