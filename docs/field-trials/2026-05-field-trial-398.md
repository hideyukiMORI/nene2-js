# FT398: validation field index 13
...
validation field index 13. Handler `bulk_vdx_fields_13` (fixture, category `validation-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT398"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT398 | 1     | PASS (automated) |
...
- Scenario `bulk_vdx_fields_13` completed under Vitest.
