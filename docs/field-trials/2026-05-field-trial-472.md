...
fixture load not-found. Handler `bulk_fixture_not_found` (fixture, category `fixtures-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| Handler     | `bulk_fixture_not_found`                                                               |
| Mode        | fixture                                                                                |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT472"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT472 | 1     | PASS (automated) |
...
- Scenario `bulk_fixture_not_found` completed under Vitest.
...
### O1: 自動シナリオ `bulk_fixture_not_found`
