# FT395: validation field index 10
...
validation field index 10. Handler `bulk_vdx_fields_10` (fixture, category `validation-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT395"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT395 | 1     | PASS (automated) |
...
- Scenario `bulk_vdx_fields_10` completed under Vitest.
