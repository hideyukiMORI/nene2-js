# FT406: validation field index 21
...
validation field index 21. Handler `bulk_vdx_fields_21` (fixture, category `validation-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT406"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT406 | 1     | PASS (automated) |
...
- Scenario `bulk_vdx_fields_21` completed under Vitest.
