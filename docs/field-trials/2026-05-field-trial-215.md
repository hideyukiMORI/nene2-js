# FT215: [py_dev] client: protected_401_fixture
...
[py_dev] client: protected_401_fixture. Handler `onb_client_py_dev_protected_401_fixture` (fixture, category `docs-client-onboarding`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| Handler | `onb_client_py_dev_protected_401_fixture` |
| Mode | fixture |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT215"
...
| Suite | Tests | Result |
| ----- | ----- | ------ |
| `ft-marathon` FT215 | 1 | PASS (automated) |
...
- Scenario `onb_client_py_dev_protected_401_fixture` completed under Vitest.
...
### O1: 自動シナリオ `onb_client_py_dev_protected_401_fixture`
