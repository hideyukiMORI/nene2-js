...
notes offset=9999. Handler `bulk_q_notes_offset_9999` (fixture, category `query-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| ----------- | -------------------------------------------------------------------------------------- |
| Category    | `query-bulk`                                                                           |
| Handler     | `bulk_q_notes_offset_9999`                                                             |
| Mode        | fixture                                                                                |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT310"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT310 | 1     | PASS (automated) |
...
- Scenario `bulk_q_notes_offset_9999` completed under Vitest.
- Persona A path: Pagination offset
...
### O1: 自動シナリオ `bulk_q_notes_offset_9999`
