# FT419: parseProblemDetails case 9
...
parseProblemDetails case 9. Handler `bulk_prob_parse_9` (fixture, category `problem-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT419"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT419 | 1     | PASS (automated) |
...
- Scenario `bulk_prob_parse_9` completed under Vitest.
