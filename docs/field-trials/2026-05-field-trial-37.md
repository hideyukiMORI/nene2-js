...
health 500 problem. Handler `health_500` (fixture, category `health`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
- Scenario `health_500` completed under Vitest.
- Persona A path: Ops alert path
