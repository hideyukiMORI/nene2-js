# FT217: [py_dev] client: html_wrong_port_hint
...
[py_dev] client: html_wrong_port_hint. Handler `onb_client_py_dev_html_wrong_port_hint` (fixture, category `docs-client-onboarding`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| Handler     | `onb_client_py_dev_html_wrong_port_hint`                                               |
| Mode        | fixture                                                                                |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT217"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT217 | 1     | PASS (automated) |
...
- Scenario `onb_client_py_dev_html_wrong_port_hint` completed under Vitest.
...
### O1: 自動シナリオ `onb_client_py_dev_html_wrong_port_hint`
