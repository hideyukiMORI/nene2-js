# FT400: validation field index 15
...
validation field index 15. Handler `bulk_vdx_fields_15` (fixture, category `validation-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT400"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT400 | 1     | PASS (automated) |
...
- Scenario `bulk_vdx_fields_15` completed under Vitest.
