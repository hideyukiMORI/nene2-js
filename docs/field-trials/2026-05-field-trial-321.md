# FT321: tags limit+offset combo 4
...
tags limit+offset combo 4. Handler `bulk_q_tags_combo_4` (fixture, category `query-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT321"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT321 | 1     | PASS (automated) |
...
- Scenario `bulk_q_tags_combo_4` completed under Vitest.
