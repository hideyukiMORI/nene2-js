# FT248: notes limit+offset combo 18
...
notes limit+offset combo 18 (`bulk_q_notes_combo_18`, fixture).

## What was exercised

`npm run test:ft-marathon` — category `query-bulk`.

## DX Review

### Persona A — TypeScript app developer

Combined query params **Risk:** low
