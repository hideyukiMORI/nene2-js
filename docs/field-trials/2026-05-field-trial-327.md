# FT327: tags limit+offset combo 7
...
tags limit+offset combo 7. Handler `bulk_q_tags_combo_7` (fixture, category `query-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT327"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT327 | 1     | PASS (automated) |
...
- Scenario `bulk_q_tags_combo_7` completed under Vitest.
