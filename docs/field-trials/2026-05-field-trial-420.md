# FT420: parseProblemDetails case 10
...
parseProblemDetails case 10. Handler `bulk_prob_parse_10` (fixture, category `problem-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT420"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT420 | 1     | PASS (automated) |
...
- Scenario `bulk_prob_parse_10` completed under Vitest.
