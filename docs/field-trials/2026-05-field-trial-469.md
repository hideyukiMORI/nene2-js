# FT469: generated schema probe 7
...
generated schema probe 7. Handler `bulk_schema_7` (fixture, category `openapi-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT469"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT469 | 1     | PASS (automated) |
...
- Scenario `bulk_schema_7` completed under Vitest.
