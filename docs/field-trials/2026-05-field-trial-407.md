# FT407: validation field index 22
...
validation field index 22. Handler `bulk_vdx_fields_22` (fixture, category `validation-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT407"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT407 | 1     | PASS (automated) |
...
- Scenario `bulk_vdx_fields_22` completed under Vitest.
