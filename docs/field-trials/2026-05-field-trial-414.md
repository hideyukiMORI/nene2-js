# FT414: parseProblemDetails case 4
...
parseProblemDetails case 4. Handler `bulk_prob_parse_4` (fixture, category `problem-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT414"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT414 | 1     | PASS (automated) |
...
- Scenario `bulk_prob_parse_4` completed under Vitest.
