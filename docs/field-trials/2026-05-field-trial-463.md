# FT463: generated schema probe 1
...
generated schema probe 1. Handler `bulk_schema_1` (fixture, category `openapi-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT463"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT463 | 1     | PASS (automated) |
...
- Scenario `bulk_schema_1` completed under Vitest.
