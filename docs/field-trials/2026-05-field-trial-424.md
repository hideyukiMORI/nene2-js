# FT424: parseProblemDetails case 14
...
parseProblemDetails case 14. Handler `bulk_prob_parse_14` (fixture, category `problem-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT424"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT424 | 1     | PASS (automated) |
...
- Scenario `bulk_prob_parse_14` completed under Vitest.
