...
fixture load health-ok. Handler `bulk_fixture_health_ok` (fixture, category `fixtures-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| Handler     | `bulk_fixture_health_ok`                                                               |
| Mode        | fixture                                                                                |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT475"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT475 | 1     | PASS (automated) |
...
- Scenario `bulk_fixture_health_ok` completed under Vitest.
...
### O1: 自動シナリオ `bulk_fixture_health_ok`
