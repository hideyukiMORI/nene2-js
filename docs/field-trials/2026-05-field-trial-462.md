# FT462: generated schema probe 0
...
generated schema probe 0. Handler `bulk_schema_0` (fixture, category `openapi-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT462"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT462 | 1     | PASS (automated) |
...
- Scenario `bulk_schema_0` completed under Vitest.
