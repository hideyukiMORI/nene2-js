...
notes list limit=150. Handler `bulk_q_notes_limit_150` (fixture, category `query-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| ----------- | -------------------------------------------------------------------------------------- |
| Category    | `query-bulk`                                                                           |
| Handler     | `bulk_q_notes_limit_150`                                                               |
| Mode        | fixture                                                                                |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT282"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT282 | 1     | PASS (automated) |
...
- Scenario `bulk_q_notes_limit_150` completed under Vitest.
...
### O1: 自動シナリオ `bulk_q_notes_limit_150`
