# FT216: [py_dev] client: validation_422_fixture
...
[py_dev] client: validation_422_fixture. Handler `onb_client_py_dev_validation_422_fixture` (fixture, category `docs-client-onboarding`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| Handler | `onb_client_py_dev_validation_422_fixture` |
| Mode | fixture |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT216"
...
| Suite | Tests | Result |
| ----- | ----- | ------ |
| `ft-marathon` FT216 | 1 | PASS (automated) |
...
- Scenario `onb_client_py_dev_validation_422_fixture` completed under Vitest.
