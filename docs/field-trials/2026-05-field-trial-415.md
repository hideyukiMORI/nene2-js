# FT415: parseProblemDetails case 5
...
parseProblemDetails case 5. Handler `bulk_prob_parse_5` (fixture, category `problem-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT415"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT415 | 1     | PASS (automated) |
...
- Scenario `bulk_prob_parse_5` completed under Vitest.
