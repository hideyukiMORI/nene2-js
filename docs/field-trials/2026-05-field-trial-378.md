# FT378: deleteNote id=2147483646
...
deleteNote id=2147483646. Handler `bulk_notes_del_2147483646` (fixture, category `notes-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| ----------- | -------------------------------------------------------------------------------------- |
| Category    | `notes-bulk`                                                                           |
| Handler     | `bulk_notes_del_2147483646`                                                            |
| Mode        | fixture                                                                                |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT378"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT378 | 1     | PASS (automated) |
...
- Scenario `bulk_notes_del_2147483646` completed under Vitest.
- Persona A path: DELETE path id
...
### O1: 自動シナリオ `bulk_notes_del_2147483646`
