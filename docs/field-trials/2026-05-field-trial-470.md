# FT470: generated schema probe 8
...
generated schema probe 8. Handler `bulk_schema_8` (fixture, category `openapi-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT470"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT470 | 1     | PASS (automated) |
...
- Scenario `bulk_schema_8` completed under Vitest.
