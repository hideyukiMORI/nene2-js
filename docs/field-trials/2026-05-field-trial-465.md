# FT465: generated schema probe 3
...
generated schema probe 3. Handler `bulk_schema_3` (fixture, category `openapi-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT465"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT465 | 1     | PASS (automated) |
...
- Scenario `bulk_schema_3` completed under Vitest.
