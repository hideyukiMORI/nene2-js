# FT206: [ts_app] client: validation_422_fixture
...
[ts_app] client: validation_422_fixture. Handler `onb_client_ts_app_validation_422_fixture` (fixture, category `docs-client-onboarding`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| Handler | `onb_client_ts_app_validation_422_fixture` |
| Mode | fixture |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT206"
...
| Suite | Tests | Result |
| ----- | ----- | ------ |
| `ft-marathon` FT206 | 1 | PASS (automated) |
...
- Scenario `onb_client_ts_app_validation_422_fixture` completed under Vitest.
