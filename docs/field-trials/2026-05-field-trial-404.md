# FT404: validation field index 19
...
validation field index 19. Handler `bulk_vdx_fields_19` (fixture, category `validation-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT404"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT404 | 1     | PASS (automated) |
...
- Scenario `bulk_vdx_fields_19` completed under Vitest.
