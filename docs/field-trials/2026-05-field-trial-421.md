# FT421: parseProblemDetails case 11
...
parseProblemDetails case 11. Handler `bulk_prob_parse_11` (fixture, category `problem-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT421"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT421 | 1     | PASS (automated) |
...
- Scenario `bulk_prob_parse_11` completed under Vitest.
