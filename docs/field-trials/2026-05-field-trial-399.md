# FT399: validation field index 14
...
validation field index 14. Handler `bulk_vdx_fields_14` (fixture, category `validation-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT399"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT399 | 1     | PASS (automated) |
...
- Scenario `bulk_vdx_fields_14` completed under Vitest.
