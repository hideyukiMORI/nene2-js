# FT402: validation field index 17
...
validation field index 17. Handler `bulk_vdx_fields_17` (fixture, category `validation-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT402"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT402 | 1     | PASS (automated) |
...
- Scenario `bulk_vdx_fields_17` completed under Vitest.
