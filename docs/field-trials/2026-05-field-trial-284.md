...
notes list limit=200. Handler `bulk_q_notes_limit_200` (fixture, category `query-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| ----------- | -------------------------------------------------------------------------------------- |
| Category    | `query-bulk`                                                                           |
| Handler     | `bulk_q_notes_limit_200`                                                               |
| Mode        | fixture                                                                                |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT284"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT284 | 1     | PASS (automated) |
...
- Scenario `bulk_q_notes_limit_200` completed under Vitest.
...
### O1: 自動シナリオ `bulk_q_notes_limit_200`
