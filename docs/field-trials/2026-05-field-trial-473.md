# FT473: fixture load validation-failed
...
fixture load validation-failed. Handler `bulk_fixture_validation_failed` (fixture, category `fixtures-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| Handler     | `bulk_fixture_validation_failed`                                                       |
| Mode        | fixture                                                                                |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT473"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT473 | 1     | PASS (automated) |
...
- Scenario `bulk_fixture_validation_failed` completed under Vitest.
