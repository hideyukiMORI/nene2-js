# FT405: validation field index 20
...
validation field index 20. Handler `bulk_vdx_fields_20` (fixture, category `validation-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT405"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT405 | 1     | PASS (automated) |
...
- Scenario `bulk_vdx_fields_20` completed under Vitest.
