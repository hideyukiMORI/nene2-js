...
notes list limit=500. Handler `bulk_q_notes_limit_500` (fixture, category `query-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| ----------- | -------------------------------------------------------------------------------------- |
| Category    | `query-bulk`                                                                           |
| Handler     | `bulk_q_notes_limit_500`                                                               |
| Mode        | fixture                                                                                |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT286"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT286 | 1     | PASS (automated) |
...
- Scenario `bulk_q_notes_limit_500` completed under Vitest.
...
### O1: 自動シナリオ `bulk_q_notes_limit_500`
