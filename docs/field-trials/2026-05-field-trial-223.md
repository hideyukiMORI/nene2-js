# FT223: [php_dev] client: health_wrong_service
...
[php_dev] client: health_wrong_service. Handler `onb_client_php_dev_health_wrong_service` (fixture, category `docs-client-onboarding`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
- Scenario `onb_client_php_dev_health_wrong_service` completed under Vitest.
