# FT396: validation field index 11
...
validation field index 11. Handler `bulk_vdx_fields_11` (fixture, category `validation-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT396"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT396 | 1     | PASS (automated) |
...
- Scenario `bulk_vdx_fields_11` completed under Vitest.
