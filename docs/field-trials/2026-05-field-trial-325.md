# FT325: tags limit+offset combo 6
...
tags limit+offset combo 6. Handler `bulk_q_tags_combo_6` (fixture, category `query-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT325"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT325 | 1     | PASS (automated) |
...
- Scenario `bulk_q_tags_combo_6` completed under Vitest.
