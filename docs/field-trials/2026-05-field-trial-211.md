# FT211: [ts_app] client: create_note_fixture
...
[ts_app] client: create_note_fixture. Handler `onb_client_ts_app_create_note_fixture` (fixture, category `docs-client-onboarding`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| Handler     | `onb_client_ts_app_create_note_fixture`                                                |
| Mode        | fixture                                                                                |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT211"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT211 | 1     | PASS (automated) |
...
- Scenario `onb_client_ts_app_create_note_fixture` completed under Vitest.
...
### O1: 自動シナリオ `onb_client_ts_app_create_note_fixture`
