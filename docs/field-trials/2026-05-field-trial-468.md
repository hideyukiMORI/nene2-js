# FT468: generated schema probe 6
...
generated schema probe 6. Handler `bulk_schema_6` (fixture, category `openapi-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT468"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT468 | 1     | PASS (automated) |
...
- Scenario `bulk_schema_6` completed under Vitest.
