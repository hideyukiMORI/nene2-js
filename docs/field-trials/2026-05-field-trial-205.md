# FT205: [ts_app] client: protected_401_fixture
...
[ts_app] client: protected_401_fixture. Handler `onb_client_ts_app_protected_401_fixture` (fixture, category `docs-client-onboarding`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| Handler | `onb_client_ts_app_protected_401_fixture` |
| Mode | fixture |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT205"
...
| Suite | Tests | Result |
| ----- | ----- | ------ |
| `ft-marathon` FT205 | 1 | PASS (automated) |
...
- Scenario `onb_client_ts_app_protected_401_fixture` completed under Vitest.
...
### O1: 自動シナリオ `onb_client_ts_app_protected_401_fixture`
