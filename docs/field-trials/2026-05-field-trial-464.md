# FT464: generated schema probe 2
...
generated schema probe 2. Handler `bulk_schema_2` (fixture, category `openapi-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT464"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT464 | 1     | PASS (automated) |
...
- Scenario `bulk_schema_2` completed under Vitest.
