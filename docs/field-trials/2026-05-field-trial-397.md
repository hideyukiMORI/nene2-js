# FT397: validation field index 12
...
validation field index 12. Handler `bulk_vdx_fields_12` (fixture, category `validation-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT397"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT397 | 1     | PASS (automated) |
...
- Scenario `bulk_vdx_fields_12` completed under Vitest.
