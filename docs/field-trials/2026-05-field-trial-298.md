...
notes offset=10. Handler `bulk_q_notes_offset_10` (fixture, category `query-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| ----------- | -------------------------------------------------------------------------------------- |
| Category    | `query-bulk`                                                                           |
| Handler     | `bulk_q_notes_offset_10`                                                               |
| Mode        | fixture                                                                                |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT298"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT298 | 1     | PASS (automated) |
...
- Scenario `bulk_q_notes_offset_10` completed under Vitest.
...
### O1: 自動シナリオ `bulk_q_notes_offset_10`
