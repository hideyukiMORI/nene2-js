# FT208: [ts_app] client: baseurl_trailing_slash
...
[ts_app] client: baseurl_trailing_slash. Handler `onb_client_ts_app_baseurl_trailing_slash` (fixture, category `docs-client-onboarding`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| Handler     | `onb_client_ts_app_baseurl_trailing_slash`                                             |
| Mode        | fixture                                                                                |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT208"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT208 | 1     | PASS (automated) |
...
- Scenario `onb_client_ts_app_baseurl_trailing_slash` completed under Vitest.
...
### O1: 自動シナリオ `onb_client_ts_app_baseurl_trailing_slash`
