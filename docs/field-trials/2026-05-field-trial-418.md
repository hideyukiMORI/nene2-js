# FT418: parseProblemDetails case 8
...
parseProblemDetails case 8. Handler `bulk_prob_parse_8` (fixture, category `problem-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT418"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT418 | 1     | PASS (automated) |
...
- Scenario `bulk_prob_parse_8` completed under Vitest.
