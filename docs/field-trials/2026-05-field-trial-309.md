# FT309: validation field index 24
...
validation field index 24 (`bulk_vdx_fields_24`, fixture).

## What was exercised

`npm run test:ft-marathon` — category `validation-bulk`.

## DX Review

### Persona A — TypeScript app developer

422 field mapping **Risk:** low
