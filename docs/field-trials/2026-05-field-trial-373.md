# FT373: fixture load validation-failed
...
fixture load validation-failed (`bulk_fixture_validation_failed`, fixture).

## What was exercised

`npm run test:ft-marathon` — category `fixtures-bulk`.

## DX Review

### Persona A — TypeScript app developer

Fixture JSON sanity **Risk:** low
