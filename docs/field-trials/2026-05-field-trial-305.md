...
tags offset=100. Handler `bulk_q_tags_offset_100` (fixture, category `query-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
| ----------- | -------------------------------------------------------------------------------------- |
| Category    | `query-bulk`                                                                           |
| Handler     | `bulk_q_tags_offset_100`                                                               |
| Mode        | fixture                                                                                |
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT305"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT305 | 1     | PASS (automated) |
...
- Scenario `bulk_q_tags_offset_100` completed under Vitest.
...
### O1: 自動シナリオ `bulk_q_tags_offset_100`
