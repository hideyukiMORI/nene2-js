# FT471: generated schema probe 9
...
generated schema probe 9. Handler `bulk_schema_9` (fixture, category `openapi-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT471"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT471 | 1     | PASS (automated) |
...
- Scenario `bulk_schema_9` completed under Vitest.
