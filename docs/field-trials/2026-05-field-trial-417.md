# FT417: parseProblemDetails case 7
...
parseProblemDetails case 7. Handler `bulk_prob_parse_7` (fixture, category `problem-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT417"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT417 | 1     | PASS (automated) |
...
- Scenario `bulk_prob_parse_7` completed under Vitest.
