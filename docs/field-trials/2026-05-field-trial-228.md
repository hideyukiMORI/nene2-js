...
live onboarding 4. Handler `onb_live_protected_journey` (live, category `docs-live-onboarding`). Live — requires `NENE2_JS_API_BASE_URL` and running NENE2 / nene2-python (see ft-evac-ports).
...
- Scenario `onb_live_protected_journey` completed under Vitest.
- Persona A path: サーバ起動後に ja howto/live-smoke を実行
- Persona B path: 8080/8000/18080 の取り違えを疑う
...
### O1: 自動シナリオ `onb_live_protected_journey`
