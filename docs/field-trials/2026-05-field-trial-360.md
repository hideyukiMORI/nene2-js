...
parallel calls batch 10 (`bulk_conc_10`, fixture).

## What was exercised

`npm run test:ft-marathon` — category `concurrency-bulk`.

## DX Review

### Persona A — TypeScript app developer

Concurrent client usage **Risk:** low
