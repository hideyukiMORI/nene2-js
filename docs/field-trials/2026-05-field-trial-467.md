# FT467: generated schema probe 5
...
generated schema probe 5. Handler `bulk_schema_5` (fixture, category `openapi-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT467"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT467 | 1     | PASS (automated) |
...
- Scenario `bulk_schema_5` completed under Vitest.
