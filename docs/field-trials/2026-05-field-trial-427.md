# FT427: parseProblemDetails case 17
...
parseProblemDetails case 17. Handler `bulk_prob_parse_17` (fixture, category `problem-bulk`). Fixture / docs — `npm run test:ft-marathon` (no Docker required).
...
```text
cd nene2-js
npm run test:ft-marathon -- -t "FT427"
...
| Suite               | Tests | Result           |
| ------------------- | ----- | ---------------- |
| `ft-marathon` FT427 | 1     | PASS (automated) |
...
- Scenario `bulk_prob_parse_17` completed under Vitest.
