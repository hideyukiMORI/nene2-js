...
- [ ] **Guard codegen (ADR 0006 follow-up)** — [#86](https://github.com/hideyukiMORI/nene2-js/issues/86) Phase A done ([ADR 0007](../adr/0007-openapi-guard-codegen-ajv-standalone.md)); Phase B: `codegen:guards` pipeline
